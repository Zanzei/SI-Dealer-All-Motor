...
public class Detailpembelian implements Serializable {
    ...
    public Detailpembelian(Integer iDOrderDetails) {
        this.iDOrderDetails = iDOrderDetails;
    }

    public Detailpembelian(Integer iDOrderDetails, int harga, int jumlah, int potonganHarga) {
        this.iDOrderDetails = iDOrderDetails;
        this.harga = harga;
        this.jumlah = jumlah;
    ...
    public Pembelian getIDOrder() {
        return iDOrder;
    }

    public void setIDOrder(Pembelian iDOrder) {
    ...
    public String toString() {
        return "Model.Detailpembelian[ iDOrderDetails=" + iDOrderDetails + " ]";
    }
